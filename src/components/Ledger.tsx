  ...
  const renderRatRaceLedger = () => (
    <div className="ledger-grid">
      ...
      <div className="quadrant expense-quad">
        ...
        <div className="ledger-row divider"><span>Liabilities Pmt</span> <span className="value">${(Math.max(0, (statement.totalExpenses || 0) - (statement.taxes || 0) - (statement.otherExpenses || 0) - (statement.childExpenses || 0))).toLocaleString()}</span></div>
      ...
      <div className="quadrant asset-quad">
        ...
        {statement.assets.length === 0 && <p className="empty-msg">No assets yet...</p>}
      </div>
